...
%verifikacija koja nije potpuno automatizovana (valjda su to formalni sistemi)

%potpuno automatizovana verifikacija
	%simbolicko izvrsavanje
	%apstraktna interpretacija
	%proveravanje modela i proveravanje ogranicenih modela
