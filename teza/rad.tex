...
%CM1, MW1, KC3, KC4, PC1, PC2, PC3, PC4, MC2 
...
%4.3.1) transformacije nad podacima (uklanjanje podataka sa nedostajucim vrednostima, standardizacija, ...)
%		4.3.2) primena modela na podatke
%		4.3.3) ocena modela klasifikacije (tacnost, matrica konfuzije, preciznost, odziv, ... - generalno ono sto bude potrebno)
%		4.3.4) oversampling
%		4.3.5) ...
